...
export class DeepseekGenerationService {
  ...
  > {
    ...
    const system =
      ...
      'اكتُشفت 2026-09-18 من مراجعة حية لإجابة فعلية): الترقيم أدناه ' +
      '(1)، (2)، (3)... مخصَّص **حصراً** لاختيار الأرقام فى حقل "selected" ' +
      'الرقمى، وليس جزءاً من اللغة الموجَّهة لقارئ بشرى نهائى (رجل أعمال لا ' +
      'صلة له بترتيب عرض المرشحين عليك داخلياً). **ممنوع منعاً باتاً** أن ' +
      'يظهر فى risk_note أو conditions أى إشارة لرقم مرشح مجرَّد (أمثلة ' +
      'ممنوعة حرفياً: "(المرشح 5)"، "المرشح الثانى"، "كما ورد فى المرشح ' +
      'رقم 2") — استشهد دائماً بدلاً من ذلك بالاسم القانونى الكامل تماماً ' +
      'كما ورد فى نص المرشح نفسه أسفل هذا التعليمات (رقم المادة + اسم ' +
      'القانون/القرار + رقمه + سنته، مثال صحيح: "المادة 8 من قانون مكافحة ' +
      'غسل الأموال رقم 80 لسنة 2002")، فهذا هو ما يراه المستخدم فعلاً فى ' +
      'legal_basis المُعاد له، لا ترقيمك الداخلى.\n\n' +
