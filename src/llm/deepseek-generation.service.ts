...
export class DeepseekGenerationService {
  ...
  > {
    ...
    const system =
      ...
      'نسخة مُعمَّمة 2026-09-18 بعد اكتشاف حى لاحق أن الصيغة الأولى من هذه ' +
      'القاعدة [حظر أمثلة حرفية محددة فقط] لم تمنع صيغاً نحوية أخرى للفكرة ' +
      'نفسها — راجع تقرير الإصلاح الثانى بنفس التاريخ): الترقيم أدناه ' +
      '(1)، (2)، (3)... مخصَّص **حصراً** لاختيار الأرقام فى حقل "selected" ' +
      'الرقمى، وليس جزءاً من اللغة الموجَّهة لقارئ بشرى نهائى (رجل أعمال لا ' +
      'صلة له بترتيب عرض المرشحين عليك داخلياً). **ممنوع منعاً باتاً، بأى ' +
      'صيغة نحوية على الإطلاق** — مفرداً أو مثنى أو جمعاً، معرَّفاً أو ' +
      'نكرة، رقماً أو كلمة — أن يشير risk_note أو conditions لموقع/رقم/ ' +
      'ترتيب أى مرشح فى القائمة الداخلية المعروضة عليك أدناه؛ هذا يشمل ' +
      '(بلا حصر — المبدأ هو المنع العام لا هذه القائمة تحديداً): ' +
      '"(المرشح 5)"، "المرشح الثانى"، "كما ورد فى المرشح رقم 2"، ' +
      '"المرشحان 3 و4"، "المرشحون 1 و2 و3"، "المرشحات الثلاث الأولى". ' +
      'حتى عند تفسير **سبب استبعاد** مرشح من الحكم، لا تذكر رقمه أو موقعه ' +
      'إطلاقاً — صِفه فقط بمضمونه القانونى الفعلى (مثال ممنوع حرفياً: ' +
      '"المرشحان 3 و4 يتعلقان بمؤشرات استرشادية ولا يصلحان أساساً للحكم"؛ ' +
      'الصياغة الصحيحة بدلاً منها: "المادة 12 من قرار 161 لسنة 2024 تخص ' +
      'المؤشرات الاسترشادية للاشتباه لا واجب الإبلاغ ذاته، والمادة 3 من ' +
      'اللائحة التنفيذية رقم 951 لسنة 2003 تختص باختصاصات الوحدة لا ' +
      'بالتزامات الجهة المُبلِّغة، فلا تصلحان أساساً لهذا الحكم"). استشهد ' +
      'دائماً بدلاً من ذلك بالاسم القانونى الكامل تماماً كما ورد فى نص ' +
      'المرشح نفسه أسفل هذا التعليمات (رقم المادة + اسم القانون/القرار + ' +
      'رقمه + سنته، مثال صحيح: "المادة 8 من قانون مكافحة غسل الأموال رقم ' +
      '80 لسنة 2002")، فهذا هو ما يراه المستخدم فعلاً فى legal_basis ' +
      'المُعاد له، لا ترقيمك الداخلى.\n\n' +
  ...
  > {
    ...
    const system =
      ...
      'مثنى/جمع، رقماً أو كلمة)، أن يذكر "note" رقم أو موقع أى مرشح فى ' +
      'القائمة الداخلية؛ استشهد دائماً باسم القانون/القرار الكامل + رقم ' +
      'المادة كما وردت فى نصها.\n\n' +
