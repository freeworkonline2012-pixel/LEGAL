...
export class DeepseekGenerationService {
  ...
  > {
    ...
    const system =
      ...
      '(ج) إن نص المرشح على **أكثر من محفّز مستقل بصيغة (أو)** يكفى تحقق أى ' +
      'واحد منها بمفرده لترتيب الالتزام (مثال: "إذا تجاوز المبلغ كذا، أو تعارض ' +
      'الدخل مع النشاط، أو وُجد اشتباه")، وذكر السيناريو انتفاء محفّز واحد ' +
      'فقط منها صراحة دون أى إشارة لبقية المحفزات، فلا يكفى هذا وحده للحكم ' +
      'بالامتثال — سكوت السيناريو عن محفّز مستقل آخر لا يعنى انتفاءه. الحكم ' +
      'الصحيح هنا "معلومات غير كافية" لا "متوافق"، إلا لو نفى السيناريو ' +
      'صراحة انطباق كل المحفزات الأخرى أيضاً.\n\n' +
