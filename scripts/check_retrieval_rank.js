...
const TARGETS = [
  ...
  },
  {
    ...
    lawYear: 2026,
    articleNo: 2,
    // ⚠️ إصلاح 2026-09-18: النص السابق هنا كان مبتوراً (205 حرفاً، qHash
    // محلى=5d935634) — يفتقد الجملة الختامية "وأتمت التوفيق قبل انتهاء
    // المهلة." الموجودة فعلياً فى golden_governance_test_set_v1.json
    // (gov-182.action_description، 238 حرفاً، qHash محلى=ff7f15d3). اكتُشف
    // هذا التباين أثناء تجهيز trigger_gov182_call.js — أى رتبة دلالية
    // مُحسَبة سابقاً بهذا السكربت لـgov-182 كانت لنص مختلف عن السؤال
    // الفعلى المُرسَل فى Golden Test Set، وبالتالى غير موثوقة. تم تصحيحه
    // للنص الكامل الحرفى المطابق للملف.
    question:
